...
wordcloud_netflix = WordCloud(width=800, height=500, random_state=21, max_font_size=110,background_color='white').generate(all_words_netflix)
...
wordcloud_prime = WordCloud(width=800, height=500, random_state=21, max_font_size=110,background_color='white').generate(all_words_prime)
plt.figure(figsize=(10, 7))
